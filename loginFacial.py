...
def registro():
    ...
    carpeta_principal = os.path.dirname(__file__) # Dirección de la carpeta principal
    carpeta_imagenes = os.path.join(carpeta_principal, "imagenesDetector") # Directorio de imágenes
    dir = file=os.path.join(carpeta_imagenes, "Logo.png") # dirección imagen (logo)
    ...
    Label(pantalla1, text = "", bg='#8E8D8E').pack()
    Label(pantalla1, text = "CUI").pack()  #Mostramos en la pantalla 1 la contraseña
    Label(pantalla1, text = "", bg='#8E8D8E').pack()
...
def pantalla_principal():
    ...
    pantalla = Tk()
    pantalla.geometry("800x250")  #Asignamos el tamaño de la ventana 
    ...
    dir1 = file=os.path.join(carpeta_imagenes, "Logo.png") # dirección imagen1 (logo)

    dir2 = file=os.path.join(carpeta_imagenes, "Unsa.png") # dirección imagen2
    ...
    Label(text = "SISTEMA DE MATRÍCULAS",fg="white", bg = "#5C0A1B", width = "300", height = "2", font = ("Open Sans", 13)).pack() #Asignamos caracteristicas de la ventana
